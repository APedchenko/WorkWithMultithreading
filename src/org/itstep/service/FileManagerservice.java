...
public class FileManagerservice {
    ...
    private static final String filePath = MAIN_DIR + SEPARATOR + "files" + SEPARATOR + "conection_log.txt";
    ...
    public static List<ConnectionData> getDataFromFile() {
        ...
        try (FileReader fileReader = new FileReader(filePath);
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ConnectionData connectionData = getDateFromLine(line);
    ...
    private static ConnectionData getDateFromLine(String line) {
    ...
    public static void writeDataToFile(ConnectionData connectionData, boolean append) {
        try (FileWriter fileWriter = new FileWriter(filePath, append)) {
            fileWriter.write(connectionData.getSesionid() + "" + connectionData.getTime() + ""
